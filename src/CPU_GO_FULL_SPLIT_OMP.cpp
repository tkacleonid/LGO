...
*/
void fnGetOptValueOnCPUSortOMP(const double *inBox, const int inRank, const int inNumBoxesSplitCoeff, const double inEps, const double inMaxIter, void (*inFun)(const double *,int,double *), double *outBox, double*outMin, double *outEps,int *outStatus)
{
